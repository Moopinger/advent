...
// I initially used a slice here that contained a-zA-Z and for the score we just added 1 to the key/index, however i later saw this and it is much better
// Score() stolen from https://github.com/Nikscorp/advent_of_code_2022/blob/master/days/day3.go
...
func (b *BackPack) UpdateBackBackId(newid int64) {
	b.Id = newid
}
